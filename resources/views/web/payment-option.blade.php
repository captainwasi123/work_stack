...
<section class="comparison-sec yellow-bg">
	<div class="container comparison-sec1 ">
		<div class="row">
		 	<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
		 		<div class="steps-text pad-top-20 pad-bot-20">
		...
		<div class="row">
			<div class="col-lg-8 col-md-7 col-12">				
				<div class="payment-data">
					...
					<div class="payment-data-inner">
						<form>
							<div class="row">
								<div class="col-lg-4 pad-top-30">
				...
				<div class="payment-summary">
					...
					<div class="payment-summary-2">
						<div class="row">
							...
							<div class="col-lg-4 col-m-4 col-4">
								<div class="summary2-text">
							...
							<div class="col-lg-12 col-md-12 col-12 pad-top-20">
